...
ActiveRecord::Schema.define(:version => 20120308163348) do
  ...
  create_table "project_services_projects", :id => false, :force => true do |t|
  ...
  create_table "requirement_priorities", :force => true do |t|
    t.string   "name"
